...
# S6 · Ortak Kabul-Sözleşmesi — escrow-partner (authorize/capture/refund) ↔ Sester (verify/settle)

> Taraflar: **sester** (metering/policy/evidence/facilitator, v0.4.0 — S5
> facilitator_svc kodlandı) · **escrow-partner (64)** (ticaret/escrow, CSVO imzalı).
...
> the partner's internal acknowledgment note.

## 1) Sorumluluk-bölüşümü (tek-ledger, çift-kanıt)

| Ödeme-anı | escrow-partner (64) (ticaret) | sester (kanıt) | Ortak ledger olayı |
|---|---|---|---|
...
(64: CSVO Ed25519, 63: hash-chain) → S6 KAPANDI beyanı milestone plan §7'ye düşer.
...
2. Karşı-taraf-olayı alan-uzlaşması — **KAPANDI**: 64-tarafı haritası
   (partner-side joint-acceptance record) real

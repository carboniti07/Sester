...
- Kimlik-dizisi: `workspace/63-Pugio` -> `workspace/63-Sikke` -> **`workspace/sester`**
- Tarih: 2026-09-13
...
- **Kanonik kopya (2026-09-13):** kardeş-repolar yeniden konumlandı
  (`workspace/TamgaProtocol`, `workspace/Veridict`) — alıcıların
...
dokunulmaz (`docs/adr/0003` §deprekasyon-politikası).

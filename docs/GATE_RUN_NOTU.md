...
# Kapı-Geçişi Notu — escrow-partner'in beklediği koşum (2026-09-13)

> Bu notu Sester oturumunda **tek komutla** koşun; escrow-partner'in S6'yı
> bizim kapı-yeşilimize kilitlediği unutulmasın
> (the partner's acknowledgment row).
...
2. **PyPI lisans-eşiği: A) AÇIK-ÇEKİRDEK (Apache-2.0)** — "para-kazanma-şansını
   ...
   **Sonuç-yükümlülüğü:** (a) at public-publication day the project moves out of the internal workspace folder
   ...
   internal sibling references (partner paths, the coordination protocol,
...
3. **escrow-partner'e sinyal**: kapı-yeşili haberini verin — S6 ortak-turunu
...
- **Sıfır RED → 100/100 mührü verildi.** escrow-partner'e sinyal-notu yazıldı
  (partner-side S6 green-light note) — S6 ortak-turu açık.

...
# Sibling repos are optional: set SESTER_TAMGA_PATH / SESTER_VERIDICT_PATH
# to run the cross-repo legs; without them the embedded mirrors are used.
TAMGA = os.environ.get("SESTER_TAMGA_PATH", "")
VERIDICT = os.environ.get("SESTER_VERIDICT_PATH", "")

...
2. **The K0 envelope is frozen.** `canonical_line` / the evidence-bundle schema
   ...
   `source: "sikke"`) — kept until protocol v2 (see `docs/adr/0006_identity_history.md`).
...
- Breaking changes require a decision record (see `docs/adr/0003_doctrine_decision_record.md` for format).

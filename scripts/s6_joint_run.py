#!/usr/bin/env python3
"""S6 joint runner — escrow-partner ⟷ Sester facilitator (single ledger).

63-tarafı kanıt-koşumu (milestone plan §7 S6; docs/S6_JOINT_ACCEPTANCE.md §3):
...
# ---------------------------------------------------------------- 64-gölge-makinesi
# partner escrow-module passthrough matrix (exact;  (birebir; S6 koşumunda
